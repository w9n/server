...
class CollaborationResourcesController extends OCSController {
	 ...
	 * @return DataResponse<CoreCollection, Http::STATUS_OK>|DataResponse<array, Http::STATUS_NOT_FOUND|Http::STATUS_INTERNAL_SERVER_ERROR>
	 *
	 ...
	 * @return DataResponse<CoreCollection[], Http::STATUS_OK>|DataResponse<array, Http::STATUS_NOT_FOUND>
	 *
	 ...
	 * @return DataResponse<CoreCollection, Http::STATUS_OK>|DataResponse<array, Http::STATUS_BAD_REQUEST|Http::STATUS_NOT_FOUND|Http::STATUS_INTERNAL_SERVER_ERROR>
	 *
	 * 200: Collection returned
