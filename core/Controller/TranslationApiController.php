...
class TranslationApiController extends \OCP\AppFramework\OCSController {
	 ...
	 * @return DataResponse<array{text: string}, Http::STATUS_OK>|DataResponse<array{message: string}, Http::STATUS_BAD_REQUEST|Http::STATUS_PRECONDITION_FAILED|Http::STATUS_INTERNAL_SERVER_ERROR>
	 *
