...
class HeartbeatController extends OCSController {
	 ...
	 * @NoAdminRequired
	 *
	 * @param UserStatusType $status Only online, away
	 *
	 * @return DataResponse<UserStatusPrivate, Http::STATUS_OK>|DataResponse<array, Http::STATUS_BAD_REQUEST|Http::STATUS_INTERNAL_SERVER_ERROR|Http::STATUS_NO_CONTENT>
