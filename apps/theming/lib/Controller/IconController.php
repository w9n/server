...
class IconController extends Controller {
	 ...
	 *
	 * @param string $app ID of the app
	 * @return FileDisplayResponse<Http::STATUS_OK>|DataDisplayResponse<Http::STATUS_OK>|NotFoundResponse
	 * @throws \Exception
	 *
	 ...
	 *
	 * @param string $app ID of the app
	 * @return DataDisplayResponse<Http::STATUS_OK>|FileDisplayResponse<Http::STATUS_OK>|NotFoundResponse
	 * @throws \Exception
	 *
