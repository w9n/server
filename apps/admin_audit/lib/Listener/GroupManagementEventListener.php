...
class GroupManagementEventListener extends Action implements IEventListener {
	...
	private function userAdded(UserAddedEvent $event) {
	...
	private function userRemoved(UserRemovedEvent $event) {
	...
	private function groupCreated(GroupCreatedEvent $event) {
	...
	private function groupDeleted(GroupDeletedEvent $event) {
