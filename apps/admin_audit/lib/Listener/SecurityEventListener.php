...
class SecurityEventListener extends Action implements IEventListener {
	...
	private function twoFactorProviderForUserEnabled(TwoFactorProviderForUserEnabled $event) {
		$this->log(
	...
	private function twoFactorProviderForUserDisabled(TwoFactorProviderForUserDisabled $event) {
		$this->log(
